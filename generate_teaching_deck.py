    ...
    return [
        ...
        Slide(
            ...
            notes=(
                ...
                "The maintenance model in the last bullet deserves a sentence of interpretation "
                "rather than being left as a list, because it is the bullet most likely to be "
                "skimmed and it is the one that connects to everything later. A reactive ticket "
                "queue is a perfectly sound way to maintain most software, since most defects "
                "announce themselves - something breaks, and a user reports it. Silent "
                "degradation produces no reporter. Nobody raises a ticket saying the model got "
                "quietly worse this quarter. A reactive queue is therefore structurally "
                "incapable of catching the failure mode that matters most in this class of "
                "system, and that is the bridge from this slide to the drift material later. "
        ...
        Slide(
            ...
            notes=(
                ...
                "succeeds on every metric anyone is currently measuring, which is exactly why "
                "the gaps matter: success indicators and safety indicators are different "
