...
def slides() -> list[Slide]:
    return [
        ...
        Slide(
            title="The asymmetry nobody closes",
            bullets=(
                "Design-time review asks: is this system well designed and validated?",
                "That question gets asked thoroughly, by qualified people, with documented "
                "outcomes.",
                "Field assessment asks: is the system running right now still the one we "
                "validated?",
                "In my experience that second question has no owner, no cadence, and no "
                "instrument.",
            ),
            callout=(
                "Validation is a point-in-time event. An AI-assisted system drifts "
                "continuously, and much of the drift is invisible to change control as "
                "currently written."
            ),
            notes=(
