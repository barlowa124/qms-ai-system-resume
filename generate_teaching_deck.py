    ...
    return [
        ...
        Slide(
            ...
            bullets=(
                ...
                "Before I left I filed a memo asking one question: what operational standard "
                "should the alpha ship under, given the gap between the AI layer's practices "
                "and the standard the same organisation applied elsewhere.",
                "I built that case from the organisation's own records rather than from "
                "opinion, and I credited the engineering discipline demonstrated elsewhere in "
                "it.",
                "I was the product owner. I was not prepared to take the alpha live without an "
                "answer to that question, so I left and built the instrument instead.",
            ),
            callout=(
